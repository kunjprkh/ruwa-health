  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-green-600 text-white shadow-sm hover:bg-green-700 hover:shadow-md",
        warning:
          "border-transparent bg-yellow-600 text-white shadow-sm hover:bg-yellow-700 hover:shadow-md",
      },
    },
    defaultVariants: {
      variant: "default",
